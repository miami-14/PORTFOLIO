...
<button> <li><a href="../Accueil/accueil.php" data-text="Acceuil">Acceuiltest</a></li> </button>
<button> <li><a href="../Compétences/competences.php" data-text="Compétences">Compétences</a></li> </button>
